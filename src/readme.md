To build the example programs, you need to install [WLA DX](http://www.villehelin.com/wla.html), an assembler for 65816 processors that comes with special directives for creating Super Nintendo ROMs.
